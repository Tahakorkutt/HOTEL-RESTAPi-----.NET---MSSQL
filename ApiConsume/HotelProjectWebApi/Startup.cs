...
namespace HotelProjectWebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services) // swagger entegre
        {
            ...
            services.AddAutoMapper(typeof(Startup)); // automapper entegre
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseRouting();
            app.UseCors("OtelApiCors");//cors entegre
